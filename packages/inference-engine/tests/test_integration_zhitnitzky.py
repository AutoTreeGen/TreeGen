...
Phase 7.5 (ADR-0057): Bayesian fusion заменила weighted sum.
...
def test_sex_mismatch_kills_zhitnitzky_match() -> None:
    ...
    Phase 7.5 (ADR-0057): SexConsistencyRule выпускает CONTRADICTS,
    ...
    Trade-off задокументирован в ADR-0057 §«Consequences».
    """
    _register_default_rules()
