"""StripeCustomer — связь user ↔ Stripe Customer (Phase 12.0, ADR-0042).
...
стороне Stripe (см. ADR-0042 §«GDPR»). У нас в БД — только маппинг ID.

Без soft-delete: revocation = hard delete после account deletion
(carry-forward правило из GDPR Art. 17 — schema_invariants invariant).
"""
