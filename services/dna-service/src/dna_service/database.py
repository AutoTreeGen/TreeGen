"""Async engine + session factory для dna-service.

Зеркалит parser-service/database.py (та же стратегия: один engine
на процесс, audit-listeners регистрируются один раз).
"""
